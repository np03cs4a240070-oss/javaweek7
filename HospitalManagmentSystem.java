...
public class HospitalManagmentSystem {
	...
	public static void main(String[] args) {
		//Default constructor
		Doctor d = new Doctor("D001", "Sushan Shrestha ", 21, "Male", "Kathmandu", 97494, "D334", "Neurology");
		Patient p = new Patient("P001", "Diya Dangol ", 19, "Female", "Kathmandu", 9874560, "D333");
